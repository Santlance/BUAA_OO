...
public class MyUmlClass {
    ...
    private ArrayList<MyUmlAssociationEnd> classAssociationEnd;
    ...
    public MyUmlClass(String parent, String visibility,
        ...
        this.classAssociationEnd = new ArrayList<>();
    ...
    public void addAssociationEnd(MyUmlAssociationEnd umlAssociationEnd) {
        classAssociationEnd.add(umlAssociationEnd);
    }
    ...
    public ArrayList<MyUmlAttribute> getClassAttribute() {
        return classAttribute;
    }

    public ArrayList<MyUmlAssociationEnd> getClassAssociationEnd() {
        return classAssociationEnd;
    }
